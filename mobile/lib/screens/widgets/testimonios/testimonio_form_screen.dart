...
//
// Igual al original pero acepta [paisForzado] para que el admin_pais
// no pueda cambiar el país al crear un testimonio.
...
class TestimonioFormScreen extends StatefulWidget {
  ...
  /// Si viene del admin_pais, el país se fija y no se puede cambiar.
  final String? paisForzado;

  const TestimonioFormScreen({
    super.key,
    this.testimonioExistente,
    this.paisForzado,
  });
...
class _TestimonioFormScreenState extends State<TestimonioFormScreen> {
  ...
  bool get _paisBloqueado => widget.paisForzado != null;
  ...
  void initState() {
    ...
    // Si viene el país forzado, úsalo
    if (widget.paisForzado != null) {
      _pais = widget.paisForzado!.toLowerCase();
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                      ...
                      errorBuilder: (_, __, ___) => Container(
                        ...
                        child: const Center(
                          child: Text('URL de imagen no válida',
                              style: TextStyle(
                                  color: AppColors.fieldLabel, fontSize: 12)),
                        ),
                      ),
                    ),
                  ),
              ...
              const SizedBox(height: 10),
              _tarjeta(Column(children: [
                // País — bloqueado si viene de admin_pais
                if (_paisBloqueado)
                  // Solo muestra el país, no permite cambio
                  Container(
                    width:   double.infinity,
                    ...
                    child: Row(children: [
                      const Icon(Icons.location_on_outlined,
                          size: 20, color: AppColors.fieldIcon),
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Text(
                          _paises.firstWhere((p) => p.$1 == _pais,
                              orElse: () => (_pais, _pais)).$2,
                      ...
                      const Icon(Icons.lock_outline,
                          size: 16, color: AppColors.fieldLabel),
                    ]),
                  )
                else
                  _dropdown<String>(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _guardando
                      ...
                      : Text(
                          _esEdicion ? 'Guardar cambios' : 'Crear testimonio',
                          style: const TextStyle(
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: const TextStyle(
              fontSize: 13, color: AppColors.fieldLabel),
        ),
      );
